...
#define fl at<float>
const char* usage =
    "usage: ./train_patch_model annotation_file shape_model_file "
    "patch_model_file"
...
//==============================================================================
int parse_face_width(int argc, char** argv) {
  for (int i = 1; i < argc; i++) {
    string str = argv[i];
...
//==============================================================================
int parse_patch_size(int argc, char** argv) {
  for (int i = 1; i < argc; i++) {
    string str = argv[i];
    if (str.length() != 2) continue;
...
//==============================================================================
int parse_search_window_size(int argc, char** argv) {
  for (int i = 1; i < argc; i++) {
    string str = argv[i];
    if (str.length() != 2) continue;
